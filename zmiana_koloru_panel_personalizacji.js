...
function zmiana_koloru_panel_personalizacji() {
                    ...
                    document.getElementById('panel_personalizacji').style.backgroundColor = kolor_obudowy;
                    ...
                    document.getElementById('instrukcje_personalizacji').style.border = "6px double "+kolor_ramki;
                    ...
                    var pd = document.getElementsByClassName('personalizacja_div');
                    for(var kj = (pd.length - 1); kj >= 0; kj--) {
                        pd[kj].style.border = "1px solid "+kolor_ramki;
                    }
                    ...
                    function tabela_przepisanie_koloru() {
                        ...
                        var kolor;
                        for (var a = (tabela.length - 1); a >= 0; a--) {
                            kolor = tabela[a].innerHTML;
                            tabela[a].style.backgroundColor = kolor;
                            tabela[a].innerHTML='';
                        }
                    }
                    tabela_przepisanie_koloru();
